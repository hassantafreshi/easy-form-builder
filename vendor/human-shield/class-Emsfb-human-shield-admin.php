...
class Emsfb_Human_Shield_Admin {
	...
	private function labels() {
		return array(
			// Values are rendered by the admin JS with its escaping helper. Do not
			// HTML-escape them here as well or an ampersand becomes literal &amp;.
			'title'          => __( 'Form Security & Spam Protection', 'easy-form-builder' ),
			'subtitle'       => __( 'Behavior-based anti-spam and cost protection', 'easy-form-builder' ),
			'overview'       => __( 'Overview', 'easy-form-builder' ),
			'protection'     => __( 'Protection', 'easy-form-builder' ),
			'paidLimits'     => __( 'Paid Limits', 'easy-form-builder' ),
			'logs'           => __( 'Logs', 'easy-form-builder' ),
			'system'         => __( 'System', 'easy-form-builder' ),
			'save'           => __( 'Save Settings', 'easy-form-builder' ),
			'saving'         => __( 'Saving...', 'easy-form-builder' ),
			'saved'          => __( 'Settings saved.', 'easy-form-builder' ),
			'failed'         => __( 'Request failed.', 'easy-form-builder' ),
			'enabled'        => __( 'Enabled', 'easy-form-builder' ),
			'mode'           => __( 'Mode', 'easy-form-builder' ),
			'monitor'        => __( 'Monitor only', 'easy-form-builder' ),
			'softBlock'      => __( 'Soft block', 'easy-form-builder' ),
			'strict'         => __( 'Strict', 'easy-form-builder' ),
			'clearLogs'      => __( 'Clear Logs', 'easy-form-builder' ),
			'configMissing'  => __( 'The Security & Spam Protection admin data could not be loaded. Another plugin may be blocking the script settings, or the page was cached. Reload the page; if it persists, disable admin script optimization for this page.', 'easy-form-builder' ),
			'renderFailed'   => __( 'The Security & Spam Protection panel failed to render. Reload the page or check the browser console.', 'easy-form-builder' ),
			'missingRequired' => __( 'Protection is paused: required PHP functions are disabled on this server: %s. Ask your host to remove them from the disable_functions line in php.ini. Your forms keep working without protection until then.', 'easy-form-builder' ),
			'missingTables'  => __( 'Protection is paused: the add-on database tables could not be created. Check that the database user can CREATE tables, then reload this page.', 'easy-form-builder' ),
		);
	}
