             ...
             switch(l.id){
                 ...
                 if((typeof ajax_object_efm) == 'object'){
                    console.log("ajax !");
                     ...
                     const o = [{ id_: l.dataset.vid, name: ob.name,amount:ob.amount, type:ob.type, value: l.innerHTML, session: sessionPub_emsFormBuilder }];                     
                     indx = sendBack_emsFormBuilder_pub.findIndex(x => x.id_ === l.dataset.vid);
                     indx == -1 ? sendBack_emsFormBuilder_pub.push(o[0]) : sendBack_emsFormBuilder_pub[indx].value=l.innerHTML;
