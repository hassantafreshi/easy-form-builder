 ...
 function FunSearchTableEfb(dataSetId){
  ...
  document.addEventListener("click", (evnt) => {
     ...
     //   console.log(evnt.target);
      IsmenuC=(el)=>{
       let id      
        while (id!='wpbody-content' && id!='sideMenuFEfb' && id!="deleteOption") {
          el=el.parentNode;
             ...
             switch(l.id){
                 ...
                 if((typeof ajax_object_efm) == 'object'){
                    ...
                    const v= l.innerHTML.replaceAll(`,` , "@efb!");
                     let ob = valueJson_ws.find(x => x.id_ === l.dataset.vid); 
                     const o = [{ id_: l.dataset.vid, name: ob.name,amount:ob.amount, type:ob.type, value: v, session: sessionPub_emsFormBuilder }];                     
                     indx = sendBack_emsFormBuilder_pub.findIndex(x => x.id_ === l.dataset.vid);
                     indx == -1 ? sendBack_emsFormBuilder_pub.push(o[0]) : sendBack_emsFormBuilder_pub[indx].value=v;
