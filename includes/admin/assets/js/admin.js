...
console.info('Easy Form Builder 3.5.12> WhiteStudio.team');
  ...
  setTimeout(() => {
    ...
    switch (el.id) {
      ...
      case "hideLabelEl":
        ...
        console.log('==============>hideLabelEl' ,valj_efb[indx].hflabel);
...
window.addEventListener("popstate",e=>{
  ...
  switch(e.state){
    ...
    case 'help':      
      ...
      break;
    case 'search':
      v = localStorage.getItem("search_efb");
