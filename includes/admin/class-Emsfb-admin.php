...
class Admin {
           ...
           /*  wp_enqueue_script('popper-js', EMSFB_PLUGIN_URL . 'includes/admin/assets/js/popper.min.js');
            wp_enqueue_script('popper-js');  */
             //code_v1 end
               ...
               /*  wp_enqueue_script('efb-min-js', EMSFB_PLUGIN_URL . 'includes/admin/assets/js/main.js');
    ...
    public function delete_form_id_public() {
        ...
        if (check_ajax_referer('admin-nonce', 'nonce') != 1) {
            ...
            $response = ['success' => false, 'm' => __('Secure Error 403')];
...
/*         if ($_POST['value']) {
        ...
        $response = ['success' => true, 'r' => __("update")];
        wp_send_json_success($response, $_POST);
    }
    ...
    public function set_replyMessage_id_Emsfb() {
        ...
        if (empty($_POST['message'])) {
            $response = ['success' => false, "m" => __("Something went wrong,Please refresh the page and Enter value")];
            wp_send_json_success($response, $_POST);
            die();
        }
    ...
    public function set_setting_Emsfb() {
        ...
        if (empty($_POST['message'])) {
            $response = ['success' => false, "m" => __("Please enter a message")];
            wp_send_json_success($response, $_POST);
            die();
        }
        if ($this->isHTML(json_encode($_POST['message']))) {
    ...
    public function get_ajax_track_admin() {
        ...
        if ($value[0] != null) {
            ...
            $response = ['success' => false, "m" => __("Tracking Code not found!")];
        }
    ...
    public function clear_garbeg_admin() {
        ...
        $response = ['success' => true, "m" => __("Files Deleted")];
