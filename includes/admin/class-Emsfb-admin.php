    ...
    public function admin_assets($hook) {
      ...
      /*       wp_enqueue_script('serverJs', EMSFB_PLUGIN_URL . 'includes/admin/assets/js/server.js', null, null, true);
        ...
        if (strpos($hook, 'Emsfb') && is_admin()) {
            ...
            wp_register_style('Emsfb-bootstrap', EMSFB_PLUGIN_URL . 'includes/admin/assets/css/bootstrap.min.css',true,'3.5.5');
            ...
            if (strlen($lang) > 0) {$lang = explode('_', $lang)[0];}
                ...
                wp_enqueue_script('efb-bootstrap-icon-js', EMSFB_PLUGIN_URL . 'includes/admin/assets/js/bootstrap-icon.js',false,'3.5.5');
