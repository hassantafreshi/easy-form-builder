...
class efbFunction {
	...
	public function text_efb($inp){
		...
		$lang = [
			...
			"proUnlockMsg" => $state ? $ac->text->proUnlockMsg : __('Activate Easy Form Builder Pro for more features and unlimited access to all services.','easy-form-builder'),
			...
			"youUseProElements" => $state ? $ac->text->youUseProElements : __('This feature is only available in the Pro of Easy Form Builder. To use it, activate the Easy Form Builder Pro.','easy-form-builder'),
			...
			"availableProVersion" => $state ? $ac->text->availableProVersion : __('Available in the Pro.','easy-form-builder'),
			...
			"howProV" => $state  &&  isset($ac->text->howProV) ? $ac->text->howProV : __('How to activate Easy form builder Pro','easy-form-builder'),
			...
			"yFreeVEnPro" => $state  &&  isset($ac->text->yFreeVEnPro) ? $ac->text->yFreeVEnPro : __('Did you know you can unlock even more features with Easy Form Builder Pro only $12.09/yearly? Activate now to get access to our Advanced Professional features." is grammatically correct.','easy-form-builder'),				
