...
class efbFunction {
	...
	public function text_efb($inp){
		...
		$lang = [
			...
			"clickHereToActivateProVersion" => $state ? $ac->text->clickHereToActivateProVersion : __('Click here to activate Pro version','easy-form-builder'),
			...
			"checkedBoxIAmNotRobot" => $state ? $ac->text->checkedBoxIAmNotRobot : __('Please check the box of I am not a robot','easy-form-builder'),
			...
			"proUnlockMsg" => $state ? $ac->text->proUnlockMsg : __('Activate Pro version for more features and unlimited access to all the plugin services.','easy-form-builder'),
			...
			"youUseProElements" => $state ? $ac->text->youUseProElements : __('You are using a Pro field in the form. For saving and using a form including Pro fields, activate the Pro version.','easy-form-builder'),
			...
			"allSteps" => $state ? $ac->text->allSteps : __('all steps','easy-form-builder'),
			...
			"whenEasyFormBuilderRecivesNewMessage" => $state ? $ac->text->whenEasyFormBuilderRecivesNewMessage : __('When a new message is received through Easy Form Builder, an alert email will be sent to the admin.','easy-form-builder'),
			...
			"newPassM" => $state ? $ac->text->newPassM : __('If your email is valid, a new password will be sent to your email.','easy-form-builder'),
			...
			"IMAddonPD" => $state  &&  isset($ac->text->IMAddonPD) ? $ac->text->IMAddonPD : __('Please go to Add-ons Page of Easy Form Builder plugin and install the Jalili date addon','easy-form-builder'),	
			"IMAddonAD" => $state  &&  isset($ac->text->IMAddonAD) ? $ac->text->IMAddonAD : __('Please go to Add-ons Page of Easy Form Builder plugin and install the Hijri date addon','easy-form-builder'),	
