...
class efbFunction {
	...
	public function text_efb($inp){
		$lang = [
			...
			"offerGoogleCloud" => __('To activite reCAPTCHA and Maps you have to sign up in Google cloud service which its basic service is free and Google give $350 worth of credits to the new users of Cloud service.','easy-form-builder'),
			...
			"enterAdminEmailReceiveNoti" => __('Enter Admin Email to receive notification email','easy-form-builder'),
