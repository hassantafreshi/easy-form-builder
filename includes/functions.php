...
class efbFunction {
	...
	//	error_log($ac);
		...
		$lang = [
			...
			"youCanFindTutorial" => $state ? $ac->text->youCanFindTutorial : __('Find video tutorial in beside box for tutorials document click on document button','easy-form-builder'),
			"proUnlockMsg" => $state ? $ac->text->proUnlockMsg : __('Get pro version for unlimited access to Easy Form Builder plugin.','easy-form-builder'),
