...
class efbFunction {
	...
	public function text_efb($inp){
		...
		$lang = [
			...
			"itAppearedStepsEmpty" => $state ? $ac->text->itAppearedStepsEmpty : __('It seems that some of the steps in your form are empty. Please add feild to all steps before saving.','easy-form-builder'),
