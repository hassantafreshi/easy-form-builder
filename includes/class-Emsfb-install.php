...
class Install {
	...
	static function install() {
		...
		$upgrade_path = ABSPATH . 'wp-admin/includes/upgrade.php';
						...
						$sql = "
							    CREATE TABLE IF NOT EXISTS {$table_name_stng} (
							    ...
							    CREATE TABLE IF NOT EXISTS {$table_name_msg} (
							    ...
							    CREATE TABLE IF NOT EXISTS {$table_name_rsp} (
							    ...
							    CREATE TABLE IF NOT EXISTS {$table_name_status} (
