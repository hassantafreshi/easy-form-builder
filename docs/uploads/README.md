...
مقالهٔ دوم این پوشه به‌جای «چقدر»، به «چطور امن» می‌پردازد: تهدیدهای واقعی یک فیلد بارگذاری و لایه‌هایی که افزونه به‌صورت خودکار جلویشان را می‌گیرد.

- English — [How to Secure File Uploads on a WordPress Form](EFB-Secure-File-Uploads-Guide.en.md)

پوشش: بلاک‌لیست دائمی پسوندها (شامل `html` و `svg` و دلیلش)، بررسی محتوا در برابر پسوند، تغییرنام تصادفی فایل، اعتبارسنجی دوبارهٔ URL هنگام ثبت فرم، سهمیهٔ هر بازدیدکننده، پاک‌سازی ۲۴ساعته، قواعد پیوست کادر پاسخ، چهار تنظیم مهم، و افزودنی **Form Security & Spam Protection** برای محدودیت نرخ بر پایهٔ IP و تشخیص ربات.
