...
[فهرست فرم‌های نظرسنجی](survey-form/README.md)

- راهنمای کامل کاربر نهایی برای فرم نظرسنجی و تنظیم «نمایش نتایج نظرسنجی» به ۴ زبان (نمودار میله‌ای/دایره‌ای بعد از ثبت، کلید نمایش عمومی هر فیلد و رفتار خودکار آن، سازگاری نوع فیلدها با نمودار)، به‌همراه JSON-LD FAQ schema و یادداشت‌های سئو
