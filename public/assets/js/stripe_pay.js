...
fun_add_stripe_efb = () => {
  ...
  add_ui_stripe_efb = (rndm ,cl,sub) => {
    ...
    <a class="efb  btn my-2 efb p-2 efb-square h-l-efb  efb-btn-lg float-end text-decoration-none disabled ${pub_bg_button_color_efb} ${pub_el_text_color_efb}" id="btnStripeEfb">${efb_var.text.payNow}</a>
